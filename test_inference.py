...
from superres.models import DeepLaplacianPyramidNetV2, NAPModel
...
model = NAPModel()
model.load_state_dict(torch.load('weights/model_NAP.pt', map_location=lambda storage, location: storage))
...
with torch.no_grad():
    ...
    generated.show()
    generated.save("demo/generated_2_NAP.jpg")
